<template>
  <div :val="value_">
    ...
    <div class="item">
      ...
      <span>从</span>
      <el-input-number @change="type = '2'" v-model="cycle.start" :min="1" :max="31" size="small"
        style="width: 100px;"></el-input-number>
      <span style="margin-left: 5px; margin-right: 5px;">至</span>
      <el-input-number @change="type = '2'" v-model="cycle.end" :min="2" :max="31" size="small"
        style="width: 100px;"></el-input-number>
      日
    </div>
    <div class="item">
      ...
      <span>从</span>
      <el-input-number @change="type = '3'" v-model="loop.start" :min="1" :max="31" size="small"
        style="width: 100px;"></el-input-number>
      <span style="margin-left: 5px; margin-right: 5px;">日开始，每</span>
      <el-input-number @change="type = '3'" v-model="loop.end" :min="1" :max="31" size="small"
        style="width: 100px;"></el-input-number>
      日执行一次
    </div>
    <div class="item">
      ...
      <span>本月</span>
      <el-input-number @change="type = '8'" v-model="work" :min="1" :max="7" size="small"
        style="width: 100px;"></el-input-number>
      号，最近的工作日
    </div>
    <div class="item">
