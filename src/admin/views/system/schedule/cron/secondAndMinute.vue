...
<template>
  <div :val="value_">
    ...
    <div class="item">
      ...
      <span>从</span>
      <el-input-number @change="type = '2'" v-model="cycle.start" :min="1" :max="59" size="small"
        style="width: 100px;"></el-input-number>
      <span>至</span>
      <el-input-number @change="type = '2'" v-model="cycle.end" :min="2" :max="59" size="small"
        style="width: 100px;"></el-input-number>
      {{lable}}
    </div>
    <div class="item">
      ...
      <span>从</span>
      <el-input-number @change="type = '3'" v-model="loop.start" :min="0" :max="59" size="small"
        style="width: 100px;"></el-input-number>
      <span>{{lable}}开始，每</span>
      <el-input-number @change="type = '3'" v-model="loop.end" :min="1" :max="59" size="small"
        style="width: 100px;"></el-input-number>
      {{lable}}执行一次
    </div>
    <div class="item">
      ...
      <el-checkbox-group v-model="appoint">
        <div v-for="i in 6" :key="i">
          <el-checkbox @change="type = '4'" v-for="j in 10" :key="j"
