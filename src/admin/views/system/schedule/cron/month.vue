<template>
  <div :val="value_">
    ...
    <div class="item">
      ...
      <span>从</span>
      <el-input-number @change="type = '2'" v-model="cycle.start" :min="1" :max="12" size="small"
        style="width: 100px;"></el-input-number>
      <span>至</span>
      <el-input-number @change="type = '2'" v-model="cycle.end" :min="2" :max="12" size="small"
        style="width: 100px;"></el-input-number>
      月
    </div>
    <div class="item">
      ...
      <span>从</span>
      <el-input-number @change="type = '3'" v-model="loop.start" :min="1" :max="12" size="small"
        style="width: 100px;"></el-input-number>
      <span>月开始，每</span>
      <el-input-number @change="type = '3'" v-model="loop.end" :min="1" :max="12" size="small"
        style="width: 100px;"></el-input-number>
      月执行一次
    </div>
    <div class="item">
