<template>
  <div :val="value_">
    ...
    <div class="item">
      ...
      <span>从</span>
      <el-input-number @change="type = '2'" v-model="cycle.start" :min="0" :max="23" size="small"
        style="width: 100px;"></el-input-number>
      <span>至</span>
      <el-input-number @change="type = '2'" v-model="cycle.end" :min="2" :max="23" size="small"
        style="width: 100px;"></el-input-number>
      时
    </div>
    <div class="item">
      ...
      <span>从</span>
      <el-input-number @change="type = '3'" v-model="loop.start" :min="0" :max="23" size="small"
        style="width: 100px;"></el-input-number>
      <span>时开始，每</span>
      <el-input-number @change="type = '3'" v-model="loop.end" :min="1" :max="23" size="small"
        style="width: 100px;"></el-input-number>
      时执行一次
    </div>
    <div class="item">
      ...
      <el-checkbox-group v-model="appoint">
        <div v-for="i in 3" :key="i">
          <el-checkbox @change="type = '4'" v-for="j in 10"
            v-if="parseInt((i - 1) + '' + (j - 1)) < 24" :key="j" :label="(i - 1) + '' + (j - 1)">
          </el-checkbox>
        </div>
      </el-checkbox-group>
    </div>
